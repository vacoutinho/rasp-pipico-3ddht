...
#define CURRENT_USED_TRANSFORM (DHT_exact_ID)

#define COUNT_3D_BLOCKS        8192


__uint32_t myGetTimeStamp(void);

void my3D_transform(__int32_t *tensor3d_in, __int32_t *tensor3d_out);
void my1DDCT_transform(__int32_t *vector);
...
int main() {
    ...
    __int32_t vector[8] = {0,100,200,300,400,500,600,700};
    __int32_t tensor3d_out[8][8][8], tensor3d_in[8][8][8] = { 
        {
    ...
    my1DDCT_transform(vector);

    uint32_t var, t1, t0 = myGetTimeStamp();
...
void my3D_transform_rows(__int32_t *tensor3d);
void my3D_transform_transposition(__int32_t *tensor3d_in, __int32_t *tensor3d_out);
void my1DDHT_transform(__int32_t *vector);
void my1DDCT_transform(__int32_t *vector);
void my3DDHT_from_3DSDHT(__int32_t *tensor3d_in, __int32_t *tensor3d_out);
...
void my1DDHT_adder_stage1(__int32_t *vector, __int32_t *ret_vector);
void my1DDHT_multiplier_stage(__int32_t *vector,__int32_t *ret_vector);
void my1DDHT_adder_stage2(__int32_t *vector, __int32_t *ret_vector);
void my1DDHT_adder_stage3(__int32_t *vector, __int32_t *ret_vector);

void my1DDHT_transform(__int32_t *vector)
{
    __int32_t tempVector[8];

    my1DDHT_adder_stage1(vector, tempVector);
    my1DDHT_multiplier_stage(tempVector, vector);
    my1DDHT_adder_stage2(vector, tempVector);
    my1DDHT_adder_stage3(tempVector, vector);
}
...
void my1DDHT_multiplier_stage(__int32_t *vector,__int32_t *ret_vector)
{
        ...
        ret_vector[5] = (__int32_t) float5;
        ret_vector[7] = (__int32_t) float7;
    #elif CURRENT_USED_TRANSFORM == DHT_8_ID
        //nothing to do, multiplication by 1!!
    #elif CURRENT_USED_TRANSFORM == DHT_11_ID
        ret_vector[5] = vector[5] + (vector[5] >> 2) + (vector[5] >> 3); //multiplication by (1 + 1/4 + 1/8)
        ret_vector[7] = vector[7] + (vector[7] >> 2) + (vector[7] >> 3);
    #elif CURRENT_USED_TRANSFORM == DHT_12_ID
        ret_vector[5] = vector[5] + (vector[5] >> 1); //multiplication by (1 + 1/2)
        ret_vector[7] = vector[7] + (vector[7] >> 1);
    #elif CURRENT_USED_TRANSFORM == DHT_16_ID
        ret_vector[5] = vector[5] << 1; //multiplication by (2)
        ret_vector[7] = vector[7] << 1;
    #endif
}
...
void my1DDCT_multiplier_block(__int32_t in0, __int32_t in1, __int32_t *out0, __int32_t *out1, float k, float n);
void my1DDCT_stage1(__int32_t *vector, __int32_t *ret_vector);
void my1DDCT_stage2(__int32_t *vector, __int32_t *ret_vector);
void my1DDCT_stage3(__int32_t *vector, __int32_t *ret_vector);
void my1DDCT_stage4(__int32_t *vector, __int32_t *ret_vector);
...
void my1DDCT_multiplier_block(__int32_t in0, __int32_t in1, __int32_t *out0, __int32_t *out1, float k, float n)
{
    ...
    *out0 = (__int32_t) out_float0;
    *out1 = (__int32_t) out_float1;
}
...
void my1DDCT_stage4(__int32_t *vector, __int32_t *ret_vector)
{
    ...
    ret_vector[3] = (__int32_t) (sqrt(2) * ( (float) vector[5]) );
    ret_vector[5] = (__int32_t) (sqrt(2) * ( (float) vector[6]) );
